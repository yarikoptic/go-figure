...
3dttest++                                                                                   \
   ...
   -setA equalRange.gain                                                                    \
      ...
      sub-106 "$data_dir/sub-106/sub-106.results/stats.sub-106_REML+tlrc.HEAD[Resp#1_Coef]" \
      sub-108 "$data_dir/sub-108/sub-108.results/stats.sub-108_REML+tlrc.HEAD[Resp#1_Coef]" \
      sub-112 "$data_dir/sub-112/sub-112.results/stats.sub-112_REML+tlrc.HEAD[Resp#1_Coef]" \
      sub-114 "$data_dir/sub-114/sub-114.results/stats.sub-114_REML+tlrc.HEAD[Resp#1_Coef]" \
      sub-118 "$data_dir/sub-118/sub-118.results/stats.sub-118_REML+tlrc.HEAD[Resp#1_Coef]" \
      sub-120 "$data_dir/sub-120/sub-120.results/stats.sub-120_REML+tlrc.HEAD[Resp#1_Coef]" \
      sub-124 "$data_dir/sub-124/sub-124.results/stats.sub-124_REML+tlrc.HEAD[Resp#1_Coef]" \
