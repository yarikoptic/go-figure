...
set read_ulay    = "final_epi_vr_base_min_outlier+orig.HEAD"  
set read_olay    = "anat_final.sub-000+orig.HEAD"  
set read_dir     = "."  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-000/media/qc_03_ve2a_epi2anat.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all -0.000001 1590.542720"  
set frange       = "1146.000000"  
set thrnew       = "0"  
set thrflag      = "*"  
set olay_alpha   = "No"  
set olay_boxed   = "No"  
...
set coors        = ( 2.822998 -12.6135 -0.828899 )  
set ftype        = "JPEG"  
