...
set read_olay    = "radcor.20.d02.errts.corr+orig.HEAD"  
set read_dir     = ". radcor.pb06.regress"  
...
set XXX_NPANE    = ""  
set com_pbar_str = "PBAR_SAVEIM QC_sub-000/media/qc_16_radcor_rc_regress_d02.pbar.jpg dim=64x512H"  
set subbb        = ( 0 0 0 )
set com_ulay_str = "SET_ULAY_RANGE A.all 0.000000 1286.316240"  
set frange       = "0.7"  
set thrnew       = "0.4"  
set thrflag      = "*"  
set olay_alpha   = "Yes"  
...
set coors        = ( 0.260502 -8.300999 -1.328899 )  
set ftype        = "JPEG"  
set odir         = "QC_sub-000/media"  
set impref       = "qc_16_radcor_rc_regress_d02"  
set bufac        = "2"  
set do_quit      = "QUITT"  
